import { useState } from 'react'; // Ensure this is imported only once
...
function Header() {
  ...
  const GetUserProfile = (tokenInfo) => {
    ...
    .then((resp) => {
      console.log("User profile data:", resp.data); // Log user data
      localStorage.setItem('user', JSON.stringify(resp.data));
      setUser(resp.data); // Update state directly
